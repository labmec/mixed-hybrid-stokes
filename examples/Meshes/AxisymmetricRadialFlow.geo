...
Physical Curve("NormalStress", 2) = {2};
//+
Physical Curve("NoNormalVelocity", 3) = {1,3};
//+
Physical Curve("NNormalVelocity", 4) = {4};
//+
Physical Curve("NoTangentialVelocity", 5) = {2,4};
//+
Physical Curve("NoTangentialStress", 6) = {1,3};
//+
