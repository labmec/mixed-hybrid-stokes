...
#ifndef TPZMIXEDLINEARELASTICMATERIAL
#define TPZMIXEDLINEARELASTICMATERIAL

enum AnalysisType {EGeneral, EPlaneStrain, EPlaneStress};

class TPZMixedLinearElasticMaterial : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>, TPZMatErrorCombinedSpaces<STATE>> {
